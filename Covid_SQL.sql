...
--First, we select the Data that we will be using 
...
-- likelihood of dying if one contract covid in the US.
...
--Countries with the lowest Infection Rate compared to Population
...
-- Total number of deaths and death percentage globally
